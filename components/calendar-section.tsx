    ...
    >
      <div className="relative z-10">
        <div className="supplemental mx-auto max-w-3xl text-center">
          ...
          <div className="section-lead mx-auto">Upcoming Events</div>
        </div>
          ...
          {upcomingEvents.map((event) => (
            ...
            >
              ...
              <button
                type="button"
                disabled
                className="hero-cta-btn inline-flex w-full shrink-0 cursor-default items-center justify-center px-8 py-3 text-sm font-semibold tracking-wide text-black transition duration-200 ease-out sm:w-auto"
              >
                Register
              </button>
            </div>
