...
import { deleteGalleryPreviewUrls } from "@/lib/gallery-cms/cloudinary";

/** Delete gallery-preview assets from Cloudinary (draft orphans / explicit cleanup). */
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await deleteGalleryPreviewUrls(urls);
