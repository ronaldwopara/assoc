#!/usr/bin/env node
/**
 * Optimizes asp/*.jpg to WebP and uploads to Cloudinary
 * folder: asosc/gallery-prev/african-summer-bbq
 */
...
const SOURCE_DIR = path.join(ROOT, "asp");
const OUT_DIR = path.join(ROOT, "asp", ".optimized");
const FOLDER = "asosc/gallery-prev/african-summer-bbq";
const QUALITY = 75;
...
async function main() {
  ...
  const outJson = path.join(ROOT, "scripts/.asp-upload-results.json");
