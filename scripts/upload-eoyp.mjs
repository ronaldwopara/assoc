#!/usr/bin/env node
/**
 * Optimizes eyp/*.jpg to WebP and uploads to Cloudinary
 * folder: asosc/gallery-prev/end-of-year-party
 */
...
const SOURCE_DIR = path.join(ROOT, "eyp");
const OUT_DIR = path.join(ROOT, "eyp", ".optimized");
const FOLDER = "asosc/gallery-prev/end-of-year-party";
const QUALITY = 75;
...
async function main() {
  ...
  const outJson = path.join(ROOT, "scripts/.eoyp-upload-results.json");
